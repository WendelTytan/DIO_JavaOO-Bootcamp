...
public class Main {
    public static void main(String[] args) {
        ...
        curso1.setTitulo("Curso Java");        curso1.setDescricao("Exemplo de descrição do curso Java");
        ...
        System.out.println("Conteúdos Inscritos Wendel:" + dev1.getConteudosInscritos());
        dev1.progredir();
        dev1.progredir();
        System.out.println("--");
        System.out.println("Conteúdos Inscritos Wendel:" + dev1.getConteudosInscritos());
        System.out.println("Conteúdos Concluídos Wendel:" + dev1.getConteudosConcluidos());
